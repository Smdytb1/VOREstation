...
/datum/belly/womb/process_Life()
	for(var/mob/living/M in internal_contents)
		...
		if(ishuman(M) && ishuman(owner) && owner.stat != DEAD && digest_mode == "Transform (Change Species) (EGG)" && M.stat != DEAD)
			...
			if(O.species.name == "Unathi" && O.custom_species = " ")
				P.r_hair = O.r_hair
				P.r_facial = O.r_hair
				P.g_hair = O.g_hair
				P.g_facial = O.g_hair
			...
			if(O.species.name == "Tajara" && O.custom_species = " ")
				P.r_hair = O.r_hair
				P.r_facial = O.r_hair
				P.g_hair = O.g_hair
				P.g_facial = O.g_hair
			...
			if(O.species.name == "Sergal" && O.custom_species = " ")
				P.r_hair = O.r_hair
				P.r_facial = O.r_hair
				P.g_hair = O.g_hair
				P.g_facial = O.g_hair
			...
			if(O.species.name == "Nevrean" && O.custom_species = " ")
				P.r_hair = O.r_hair
				P.r_facial = O.r_hair
				P.g_hair = O.g_hair
				P.g_facial = O.g_hair
			...
			if(O.species.name == "Human" && O.custom_species = " ")
				P.r_hair = O.r_hair
				P.r_facial = O.r_hair
				P.g_hair = O.g_hair
				P.g_facial = O.g_hair
			...
			if(O.species.name == "Slime Person" && O.custom_species = " ")
				P.r_hair = O.r_hair
				P.r_facial = O.r_hair
				P.g_hair = O.g_hair
				P.g_facial = O.g_hair
