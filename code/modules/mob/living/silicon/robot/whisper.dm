/mob/living/silicon/robot/whisper(message as text)
	var/alt_name = ""
...
/mob/living/silicon/robot/proc/whisper_say(var/message, var/datum/language/speaking = null, var/alt_name="", var/verb="whispers")
