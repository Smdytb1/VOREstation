...
/obj/item/clothing/head/helmet/space/rig
	...
	brightness_on = 4
	sprite_sheets = list("Tajara" = 'icons/mob/species/tajaran/helmet.dmi', "Sergal" = 'icons/mob/species/sergal/helmet.dmi',"Skrell" = 'icons/mob/species/skrell/helmet.dmi',"Unathi" = 'icons/mob/species/unathi/helmet.dmi',"Akula" = 'icons/mob/species/akula/helmet.dmi',"Nevrean" = 'icons/mob/species/nevrean/helmet.dmi', "Fox" = 'icons/mob/species/fox/helmet.dmi', "Fennec" = 'icons/mob/species/fennec/helmet.dmi') //Temporary suits. You only need to update the .dmi files in their respective folders.
...
/obj/item/clothing/suit/space/rig
	...
	resilience = 0.2
	can_breach = 1
	sprite_sheets = list("Tajara" = 'icons/mob/species/tajaran/suit.dmi',"Unathi" = 'icons/mob/species/unathi/suit.dmi', "Sergal" = 'icons/mob/species/sergal/suit.dmi',"Akula" = 'icons/mob/species/akula/suit.dmi',"Nevrean" = 'icons/mob/species/nevrean/suit.dmi', "Fox" = 'icons/mob/species/fox/helmet.dmi', "Fennec" = 'icons/mob/species/fennec/helmet.dmi') //Temporary suits. I found it weird that skrells didn't have chestpieces in the original
