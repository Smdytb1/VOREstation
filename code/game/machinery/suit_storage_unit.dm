...
/obj/machinery/suit_cycler
	...
	var/list/species = list("Human","Skrell","Unathi","Tajara", "Akula", "Sergal", "Nevrean", "Highlander Zorren", "Flatland Zorren")
...
/obj/machinery/suit_cycler/engineering
	...
	species = list("Human","Tajara","Skrell","Unathi", "Akula", "Sergal", "Nevrean", "Highlander Zorren", "Flatland Zorren") //Add Unathi when sprites exist for their suits.
...
/obj/machinery/suit_cycler/mining
	...
	species = list("Human","Tajara","Skrell","Unathi", "Akula", "Sergal", "Nevrean", "Highlander Zorren", "Flatland Zorren")
